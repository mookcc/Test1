package com.example.think.test1.utils.okhttp.util;
...
//        TLog.i("要连接的socket wifi====>" + wifiSSID);
...
//                TLog.i("capabilities=" + capabilities);
...
//                    TLog.i("none");
    ...
    public static void connectWifiSSID(Context context, WifiManager manager, String ssid, String
            password) {
//        TLog.e("reSetNetwork----------连接设备连入的路由---" + ssid);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//            TLog.e("当前手机系统>=Android6.0，采取兼容模式");
